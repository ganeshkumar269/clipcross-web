...
function init(settings) {
  ...
  options = {
    ...
    dev: false,
    entry: {
      file: "/./_app/start-b48878c8.js",
      css: ["/./_app/assets/start-a8cd1609.css"],
      js: ["/./_app/start-b48878c8.js", "/./_app/chunks/vendor-c49cf35e.js", "/./_app/chunks/singletons-bb9012b7.js"]
    },
    fetched: void 0,
    floc: false,
...
var manifest = {
  ...
  routes: [
    ...
    },
    {
      ...
      pattern: /^\/devices\/?$/,
      params: empty,
      a: ["src/routes/__layout.svelte", "src/routes/devices.svelte"],
      b: [".svelte-kit/build/components/error.svelte"]
    },
    {
      type: "page",
    ...
    },
    {
      ...
      pattern: /^\/clips\/?$/,
      params: empty,
      a: ["src/routes/__layout.svelte", "src/routes/clips.svelte"],
      b: [".svelte-kit/build/components/error.svelte"]
    },
    {
      type: "endpoint",
      pattern: /^\/api\/authcallback\/?$/,
      params: empty,
...
var module_lookup = {
  ...
  "src/routes/devices.svelte": () => Promise.resolve().then(function() {
    return devices;
  }),
  "src/routes/signin.svelte": () => Promise.resolve().then(function() {
    return signin;
  }),
  "src/routes/clips.svelte": () => Promise.resolve().then(function() {
    return clips;
  })
};
var metadata_lookup = { "src/routes/__layout.svelte": { "entry": "/./_app/pages/__layout.svelte-9a14b811.js", "css": ["/./_app/assets/pages/__layout.svelte-33ba8160.css"], "js": ["/./_app/pages/__layout.svelte-9a14b811.js", "/./_app/chunks/vendor-c49cf35e.js", "/./_app/chunks/navigation-20968cc5.js", "/./_app/chunks/singletons-bb9012b7.js"], "styles": null }, ".svelte-kit/build/components/error.svelte": { "entry": "/./_app/error.svelte-b5cffcd0.js", "css": [], "js": ["/./_app/error.svelte-b5cffcd0.js", "/./_app/chunks/vendor-c49cf35e.js"], "styles": null }, "src/routes/index.svelte": { "entry": "/./_app/pages/index.svelte-8b22b036.js", "css": ["/./_app/assets/pages/index.svelte-949109e2.css"], "js": ["/./_app/pages/index.svelte-8b22b036.js", "/./_app/chunks/vendor-c49cf35e.js", "/./_app/chunks/stores-57bcb912.js", "/./_app/chunks/navigation-20968cc5.js", "/./_app/chunks/singletons-bb9012b7.js"], "styles": null }, "src/routes/devices.svelte": { "entry": "/./_app/pages/devices.svelte-c20a85e0.js", "css": ["/./_app/assets/pages/devices.svelte-8c8fd0ef.css"], "js": ["/./_app/pages/devices.svelte-c20a85e0.js", "/./_app/chunks/vendor-c49cf35e.js", "/./_app/chunks/stores-57bcb912.js"], "styles": null }, "src/routes/signin.svelte": { "entry": "/./_app/pages/signin.svelte-085adfd7.js", "css": [], "js": ["/./_app/pages/signin.svelte-085adfd7.js", "/./_app/chunks/vendor-c49cf35e.js"], "styles": null }, "src/routes/clips.svelte": { "entry": "/./_app/pages/clips.svelte-64efa399.js", "css": [], "js": ["/./_app/pages/clips.svelte-64efa399.js", "/./_app/chunks/vendor-c49cf35e.js", "/./_app/chunks/stores-57bcb912.js"], "styles": null } };
...
var get$4 = async ({ headers, query }) => {
  ...
  const httpsAgent = new import_https2.default.Agent({
...
var authcallback = /* @__PURE__ */ Object.freeze({
  __proto__: null,
  [Symbol.toStringTag]: "Module",
  get: get$4
});
var parseCookies$1 = (cookie) => {
  if (!cookie)
    return {};
  const cookieArr = cookie.split(";");
  let list = {};
  cookieArr == null ? void 0 : cookieArr.forEach((i) => {
...
var get$3 = async ({ headers, params, query }) => {
  ...
  const cookies = parseCookies$1(headers == null ? void 0 : headers.cookie);
  console.log({ cookies });
...
var get$1 = async ({ params, query, headers }) => {
...
var get = async ({ headers, params, query }) => {
...
var css$2 = {
  code: "main.svelte-chzn8z{flex:1;display:flex;flex-direction:column;padding:1rem;width:100%;max-width:1024px;margin:0 auto;box-sizing:border-box}",
  map: `{"version":3,"file":"__layout.svelte","sources":["__layout.svelte"],"sourcesContent":["<script lang=\\"ts\\">import { goto } from '$app/navigation';\\nimport '../app.css';\\nconst signOut = () => {\\n    goto('/api/signout');\\n};\\n<\/script>\\n\\n\\n<main>\\n\\t<button on:click=\\"{signOut}\\">LogOut</button>\\n\\t<slot />\\n</main>\\n\\n<style>\\n\\tmain {\\n\\t\\tflex: 1;\\n\\t\\tdisplay: flex;\\n\\t\\tflex-direction: column;\\n\\t\\tpadding: 1rem;\\n\\t\\twidth: 100%;\\n\\t\\tmax-width: 1024px;\\n\\t\\tmargin: 0 auto;\\n\\t\\tbox-sizing: border-box;\\n\\t}\\n\\n</style>\\n"],"names":[],"mappings":"AAcC,IAAI,cAAC,CAAC,AACL,IAAI,CAAE,CAAC,CACP,OAAO,CAAE,IAAI,CACb,cAAc,CAAE,MAAM,CACtB,OAAO,CAAE,IAAI,CACb,KAAK,CAAE,IAAI,CACX,SAAS,CAAE,MAAM,CACjB,MAAM,CAAE,CAAC,CAAC,IAAI,CACd,UAAU,CAAE,UAAU,AACvB,CAAC"}`
};
var _layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  $$result.css.add(css$2);
  return `<main class="${"svelte-chzn8z"}"><button>LogOut</button>
...
var Routes = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  onMount(() => {
    console.log("INDEX PAGE");
    id_token.set(import_js_cookie.default.get("id_token"));
    console.log("cookies:");
    console.log(typeof import_js_cookie.default.get());
    for (let [key, val] of Object.entries(import_js_cookie.default.get()))
      console.log(val, key);
  });
  $$result.css.add(css$1);
  return `${$$result.head += `${$$result.title = `<title>Home</title>`, ""}`, ""}

<section class="${"svelte-1jlhe5t"}"><button>SignIn</button>
<a href="${"/clips"}">Clips</a>
</section>`;
});
...
var css = {
  ...
  map: `{"version":3,"file":"devices.svelte","sources":["devices.svelte"],"sourcesContent":["<script lang=\\"ts\\">import { fade, scale } from \\"svelte/transition\\";\\nimport { flip } from \\"svelte/animate\\";\\nimport { activeDevicesRoute, authRoute, id_token, refresh_token, devices } from '$lib/stores';\\nimport removeItemFromArray from '$lib/removeItemFromArray';\\nimport handleAuthentication from \\"$lib/auth/handleSignIn\\";\\nexport let name;\\nlet currentPage = \\"clips\\";\\nlet deviceArrayLength = -1;\\nlet unsub = devices.subscribe(value => deviceArrayLength = value.length);\\n<\/script>\\n\\n<main>\\n\\t<h1>Hello {name}!</h1>\\n\\t<h3>device array length {deviceArrayLength}</h3>\\n\\t<!-- <button on:click={signInButtonClicked}>SignIn</button> -->\\n\\t<!-- <button on:click={clearURL}>clearURL</button> -->\\n\\t{#if currentPage == \\"clips\\"}\\n\\t\\tDevice\\n\\t{/if}\\n\\t<!-- {#each devices as device (device)}\\n\\t\\t<div in:fade out:scale|local animate:flip={{duration: 500}}>\\n\\t\\t\\t<DeviceComp deviceId={device} on:removeDevice={(event)=>{removeItemFromArray(event.detail.text,devices)}}/> \\n\\t\\t</div>\\n\\t{:else}\\n\\t\\t<p in:fade style=\\"color: #69ca8e\\">\u0C0F \u0C2A\u0C30\u0C3F\u0C15\u0C30\u0C3E\u0C32\u0C41 \u0C32\u0C47\u0C35\u0C41 \u{1F625} </p>\\n\\t{/each} -->\\n</main>\\n\\n<style>\\n\\tmain {\\n\\t\\ttext-align: center;\\n\\t\\tpadding: 1em;\\n\\t\\tmax-width: 240px;\\n\\t\\tmargin: 0 auto;\\n\\t}\\n\\n\\th1 {\\n\\t\\tcolor: #ff3e00;\\n\\t\\ttext-transform: uppercase;\\n\\t\\tfont-size: 4em;\\n\\t\\tfont-weight: 100;\\n\\t}\\n\\n\\t@media (min-width: 640px) {\\n\\t\\tmain {\\n\\t\\t\\tmax-width: none;\\n\\t\\t}\\n\\t}\\n</style>"],"names":[],"mappings":"AA6BC,IAAI,eAAC,CAAC,AACL,UAAU,CAAE,MAAM,CAClB,OAAO,CAAE,GAAG,CACZ,SAAS,CAAE,KAAK,CAChB,MAAM,CAAE,CAAC,CAAC,IAAI,AACf,CAAC,AAED,EAAE,eAAC,CAAC,AACH,KAAK,CAAE,OAAO,CACd,cAAc,CAAE,SAAS,CACzB,SAAS,CAAE,GAAG,CACd,WAAW,CAAE,GAAG,AACjB,CAAC,AAED,MAAM,AAAC,YAAY,KAAK,CAAC,AAAC,CAAC,AAC1B,IAAI,eAAC,CAAC,AACL,SAAS,CAAE,IAAI,AAChB,CAAC,AACF,CAAC"}`
};
var Devices = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let { name } = $$props;
  let deviceArrayLength = -1;
  devices$1.subscribe((value) => deviceArrayLength = value.length);
  if ($$props.name === void 0 && $$bindings.name && name !== void 0)
    $$bindings.name(name);
  $$result.css.add(css);
  return `<main class="${"svelte-1tky8bj"}"><h1 class="${"svelte-1tky8bj"}">Hello ${escape3(name)}!</h1>
	<h3>device array length ${escape3(deviceArrayLength)}</h3>
...
var load = async ({ fetch: fetch22, page }) => {
  const res = await fetch22("/api/signin");
  console.log(res);
  res.data();
  return { status: 200 };
};
var Signin = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<main><h1>Sign In With Google</h1>
...
var Clip = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let { value } = $$props;
  ...
  if ($$props.hash === void 0 && $$bindings.hash && hash2 !== void 0)
    $$bindings.hash(hash2);
  if ($$props.deviceId === void 0 && $$bindings.deviceId && deviceId !== void 0)
    $$bindings.deviceId(deviceId);
  return `<main><span>${escape3(value)}</span>
    <span>DeviceId: ${escape3(deviceId)}</span>
    <button>Copy</button>
</main>`;
});
var Clips = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  let idToken = import_js_cookie.default.get("id_token");
  let deviceId = import_js_cookie.default.get("device_id");
  let clips2 = [tempClip];
  ...
  const onWsMessage = (data) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (dataJson.syncflow == true) {
      ...
      for (const [key, value] of Object.entries(dataJson)) {
        ...
        clips2.push(value);
        devices$1.update((value2) => [...value2, key.toString()]);
      }
    }
    if ((dataJson === null || dataJson === void 0 ? void 0 : dataJson.status) == 500) {
      console.log("Got a 500");
      yield updateRemoteClip();
    }
  });
  const updateRemoteClip = () => __awaiter(void 0, void 0, void 0, function* () {
    const cb = navigator.clipboard;
    const cbTextValue = yield cb.readText();
    ...
    if (cbTextValue) {
      let clip = {
        ...
        format: "text",
        timestamp: Date.now(),
        hash: (0, import_md5.default)(cbTextValue)
      };
      console.log("updateRemoteClip clip", clip);
      ws.send(JSON.stringify({ clip, vcbIds: ["default-web"] }));
    }
  });
  const getClipsFromServer = () => __awaiter(void 0, void 0, void 0, function* () {
    setTimeout(() => {
  ...
  return `${$$result.head += `${$$result.title = `<title>Clips</title>`, ""}`, ""}

<main><button>Get Clips</button>
    ${each(clips2, (clip, i) => `${validate_component(Clip, "ClipComp").$$render($$result, {
    value: clip.value,
    format: clip.format,
    timestamp: clip.timestamp,
    hash: clip.hash,
    deviceId: devices$1[i]
  }, {}, {})}`)}
</main>`;
});
var clips = /* @__PURE__ */ Object.freeze({
  __proto__: null,
  [Symbol.toStringTag]: "Module",
  "default": Clips
});
